    ...
    public partial class FormVerComanda : Form
    {
        ...
        private void btnEliminarProducto_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                BitacoraHelper.RegistrarActividad(SessionManager.GetInstance.Usuario.ToString(), "EliminarProducto Comanda Producto", DateTime.Now, "Se elimino un producto de la comanda", this.Name, AppDomain.CurrentDomain.BaseDirectory, "Mesas");
            }
            catch (Exception ex)
            {
